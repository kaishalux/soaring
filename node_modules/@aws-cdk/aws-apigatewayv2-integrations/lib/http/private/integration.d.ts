import { HttpConnectionType, HttpIntegrationType, HttpRouteIntegrationBindOptions, HttpRouteIntegrationConfig, IHttpRouteIntegration, PayloadFormatVersion, HttpMethod, IVpcLink } from '@aws-cdk/aws-apigatewayv2';
 ...
 * @internal
 */
export declare abstract class HttpPrivateIntegration implements IHttpRouteIntegration {
    /**
     * @experimental
     */
